...
export default component$((props: HTMLAttributes<unknown>) => (
  <svg {...props} stroke="currentColor" fill="none" stroke-width="0" width="1em" height="1em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M5.5 3H8.5V6H5.5V3Z" fill="currentColor"/>
  ...
  <path d="M15.5 13H18.5V16H15.5V13Z" fill="currentColor"/></svg>
));